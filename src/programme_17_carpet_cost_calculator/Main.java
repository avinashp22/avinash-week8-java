/**
 * Carpet Cost Calculator (Create package name ‘carpet_cost_calculator’ and create all below classes in this package)
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Total = " + calculator.TotalPrice());
